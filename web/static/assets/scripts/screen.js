...
var targetTypes = [
    ...
    {
        imgUrl: "https://api.lyra-836.appcloud.swisscom.com/static-media/images/buildpack/docker-image.svg",
        sizeRatio: 1,
    },
    {
        imgUrl: "https://api.lyra-836.appcloud.swisscom.com/static-media/images/buildpack/dotnetcore.svg",
        sizeRatio: 1,
    },
    {
        imgUrl: "https://api.lyra-836.appcloud.swisscom.com/static-media/images/buildpack/go.svg",
        sizeRatio: 1,
    },
    {
        imgUrl: "https://api.lyra-836.appcloud.swisscom.com/static-media/images/buildpack/java.svg",
        sizeRatio: 1,
    },
    {
        imgUrl: "https://api.lyra-836.appcloud.swisscom.com/static-media/images/buildpack/node.js.svg",
        sizeRatio: 1,
    },
    {
        imgUrl: "https://api.lyra-836.appcloud.swisscom.com/static-media/images/buildpack/php.svg",
        sizeRatio: 1,
    },
    {
        imgUrl: "https://api.lyra-836.appcloud.swisscom.com/static-media/images/buildpack/python.svg",
        sizeRatio: 1,
    },
    {
        imgUrl: "https://api.lyra-836.appcloud.swisscom.com/static-media/images/buildpack/ruby.svg",
        sizeRatio: 1,
    },
    ...
    {
        imgUrl: "https://api.lyra-836.appcloud.swisscom.com/static-media/images/service/smartmsg.svg",
        sizeRatio: 1,
    },
];
...
function init() {
    ...
    ws.onopen = function () {
        ...
        $("#game-msg").text("Visit " + window.location.protocol + "//" + window.location.host + " to play");
...
function draw() {
    ...
    for (var i = 0; i < targets.length; i++) {
        ...
        if ((t.posX <= 0 && t.velocityX < 0) || (t.posX >= (100 - (t.width)) && t.velocityX > 0)) {
